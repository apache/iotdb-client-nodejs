...
var TFlushReq = module.exports.TFlushReq = function(args) {
  ...
  if (args) {
    ...
    if (args.regionIds !== undefined && args.regionIds !== null) {
      this.regionIds = Thrift.copyList(args.regionIds, [null]);
    }
  }
};
TFlushReq.prototype = {};
...
TFlushReq.prototype.write = function(output) {
  ...
  if (this.storageGroups !== null && this.storageGroups !== undefined) {
    ...
    for (var iter18 in this.storageGroups) {
      if (this.storageGroups.hasOwnProperty(iter18)) {
        iter18 = this.storageGroups[iter18];
  ...
  if (this.regionIds !== null && this.regionIds !== undefined) {
    output.writeFieldBegin('regionIds', Thrift.Type.LIST, 3);
    output.writeListBegin(Thrift.Type.STRING, this.regionIds.length);
    for (var iter19 in this.regionIds) {
      if (this.regionIds.hasOwnProperty(iter19)) {
        iter19 = this.regionIds[iter19];
...
TSettleReq.prototype.write = function(output) {
  ...
  if (this.paths !== null && this.paths !== undefined) {
    ...
    for (var iter24 in this.paths) {
      if (this.paths.hasOwnProperty(iter24)) {
        iter24 = this.paths[iter24];
...
TSetConfigurationReq.prototype.write = function(output) {
  ...
  if (this.configs !== null && this.configs !== undefined) {
    ...
    for (var kiter30 in this.configs) {
      if (this.configs.hasOwnProperty(kiter30)) {
        var viter31 = this.configs[kiter30];
...
TShowTTLReq.prototype.write = function(output) {
  ...
  if (this.pathPattern !== null && this.pathPattern !== undefined) {
    output.writeFieldBegin('pathPattern', Thrift.Type.LIST, 1);
    output.writeListBegin(Thrift.Type.STRING, this.pathPattern.length);
    for (var iter41 in this.pathPattern) {
      if (this.pathPattern.hasOwnProperty(iter41)) {
        iter41 = this.pathPattern[iter41];
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i44 = 0; _i44 < _size42; ++_i44) {
          var elem45 = null;
          elem45 = new ttypes.TFile();
          elem45.read(input);
          this.files.push(elem45);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TFilesResp.prototype.write = function(output) {
  ...
  if (this.files !== null && this.files !== undefined) {
    ...
    for (var iter46 in this.files) {
      if (this.files.hasOwnProperty(iter46)) {
        iter46 = this.files[iter46];
        iter46.write(output);
      }
    }
    output.writeListEnd();
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i49 = 0; _i49 < _size47; ++_i49) {
          ...
          var val51 = null;
          key50 = input.readI32();
          val51 = new ttypes.TTimedQuota();
          val51.read(input);
          this.throttleLimit[key50] = val51;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
TThrottleQuota.prototype.write = function(output) {
  ...
  if (this.throttleLimit !== null && this.throttleLimit !== undefined) {
    ...
    for (var kiter52 in this.throttleLimit) {
      if (this.throttleLimit.hasOwnProperty(kiter52)) {
        var viter53 = this.throttleLimit[kiter52];
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i56 = 0; _i56 < _size54; ++_i56) {
          var elem57 = null;
          elem57 = input.readString();
          this.database.push(elem57);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TSetSpaceQuotaReq.prototype.write = function(output) {
  ...
  if (this.database !== null && this.database !== undefined) {
    ...
    for (var iter58 in this.database) {
      if (this.database.hasOwnProperty(iter58)) {
        iter58 = this.database[iter58];
...
var TPipeHeartbeatResp = module.exports.TPipeHeartbeatResp = function(args) {
  this.pipeMetaList = null;
  this.pipeCompletedList = null;
  this.pipeRemainingEventCountList = null;
  this.pipeRemainingTimeList = null;
  if (args) {
    if (args.pipeMetaList !== undefined && args.pipeMetaList !== null) {
      this.pipeMetaList = Thrift.copyList(args.pipeMetaList, [null]);
    } else {
      throw new Thrift.TProtocolException(Thrift.TProtocolExceptionType.UNKNOWN, 'Required field pipeMetaList is unset!');
    }
    if (args.pipeCompletedList !== undefined && args.pipeCompletedList !== null) {
      this.pipeCompletedList = Thrift.copyList(args.pipeCompletedList, [null]);
    }
    if (args.pipeRemainingEventCountList !== undefined && args.pipeRemainingEventCountList !== null) {
      this.pipeRemainingEventCountList = Thrift.copyList(args.pipeRemainingEventCountList, [null]);
    }
    if (args.pipeRemainingTimeList !== undefined && args.pipeRemainingTimeList !== null) {
      this.pipeRemainingTimeList = Thrift.copyList(args.pipeRemainingTimeList, [null]);
    }
  }
};
TPipeHeartbeatResp.prototype = {};
TPipeHeartbeatResp.prototype.read = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
...
TPipeHeartbeatResp.prototype.write = function(output) {
  output.writeStructBegin('TPipeHeartbeatResp');
  if (this.pipeMetaList !== null && this.pipeMetaList !== undefined) {
    output.writeFieldBegin('pipeMetaList', Thrift.Type.LIST, 1);
    output.writeListBegin(Thrift.Type.STRING, this.pipeMetaList.length);
    for (var iter75 in this.pipeMetaList) {
      if (this.pipeMetaList.hasOwnProperty(iter75)) {
        iter75 = this.pipeMetaList[iter75];
  ...
  if (this.pipeCompletedList !== null && this.pipeCompletedList !== undefined) {
    output.writeFieldBegin('pipeCompletedList', Thrift.Type.LIST, 2);
    output.writeListBegin(Thrift.Type.BOOL, this.pipeCompletedList.length);
    for (var iter76 in this.pipeCompletedList) {
      if (this.pipeCompletedList.hasOwnProperty(iter76)) {
        iter76 = this.pipeCompletedList[iter76];
        output.writeBool(iter76);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
  }
  if (this.pipeRemainingEventCountList !== null && this.pipeRemainingEventCountList !== undefined) {
    output.writeFieldBegin('pipeRemainingEventCountList', Thrift.Type.LIST, 3);
    output.writeListBegin(Thrift.Type.I64, this.pipeRemainingEventCountList.length);
    for (var iter77 in this.pipeRemainingEventCountList) {
      if (this.pipeRemainingEventCountList.hasOwnProperty(iter77)) {
        iter77 = this.pipeRemainingEventCountList[iter77];
  ...
  if (this.pipeRemainingTimeList !== null && this.pipeRemainingTimeList !== undefined) {
    output.writeFieldBegin('pipeRemainingTimeList', Thrift.Type.LIST, 4);
    output.writeListBegin(Thrift.Type.DOUBLE, this.pipeRemainingTimeList.length);
    for (var iter78 in this.pipeRemainingTimeList) {
      if (this.pipeRemainingTimeList.hasOwnProperty(iter78)) {
        iter78 = this.pipeRemainingTimeList[iter78];
        output.writeDouble(iter78);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
...
TServiceProvider.prototype.write = function(output) {
  ...
  if (this.nodeId !== null && this.nodeId !== undefined) {
    output.writeFieldBegin('nodeId', Thrift.Type.I32, 3);
    output.writeI32(this.nodeId);
    output.writeFieldEnd();
  }
  output.writeFieldStop();
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i81 = 0; _i81 < _size79; ++_i81) {
          var elem82 = null;
          elem82 = new ttypes.TTestConnectionResult();
          elem82.read(input);
          this.resultList.push(elem82);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TTestConnectionResp.prototype.write = function(output) {
  ...
  if (this.resultList !== null && this.resultList !== undefined) {
    ...
    for (var iter83 in this.resultList) {
      if (this.resultList.hasOwnProperty(iter83)) {
        iter83 = this.resultList[iter83];
        iter83.write(output);
      }
    }
    output.writeListEnd();
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i86 = 0; _i86 < _size84; ++_i86) {
          var elem87 = null;
          elem87 = new ttypes.TConfigNodeLocation();
          elem87.read(input);
          this.configNodeLocations.push(elem87);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        for (var _i90 = 0; _i90 < _size88; ++_i90) {
          var elem91 = null;
          elem91 = new ttypes.TDataNodeLocation();
          elem91.read(input);
          this.dataNodeLocations.push(elem91);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TNodeLocations.prototype.write = function(output) {
  ...
  if (this.configNodeLocations !== null && this.configNodeLocations !== undefined) {
    ...
    for (var iter92 in this.configNodeLocations) {
      if (this.configNodeLocations.hasOwnProperty(iter92)) {
        iter92 = this.configNodeLocations[iter92];
        iter92.write(output);
      }
    }
    output.writeListEnd();
  ...
  if (this.dataNodeLocations !== null && this.dataNodeLocations !== undefined) {
    output.writeFieldBegin('dataNodeLocations', Thrift.Type.LIST, 2);
    output.writeListBegin(Thrift.Type.STRUCT, this.dataNodeLocations.length);
    for (var iter93 in this.dataNodeLocations) {
      if (this.dataNodeLocations.hasOwnProperty(iter93)) {
        iter93 = this.dataNodeLocations[iter93];
        iter93.write(output);
      }
    }
    output.writeListEnd();
...
var TExternalServiceListResp = module.exports.TExternalServiceListResp = function(args) {
  this.status = null;
  this.externalServiceInfos = null;
  if (args) {
    if (args.status !== undefined && args.status !== null) {
      this.status = new ttypes.TSStatus(args.status);
    } else {
    ...
    if (args.externalServiceInfos !== undefined && args.externalServiceInfos !== null) {
      this.externalServiceInfos = Thrift.copyList(args.externalServiceInfos, [null]);
    } else {
      throw new Thrift.TProtocolException(Thrift.TProtocolExceptionType.UNKNOWN, 'Required field externalServiceInfos is unset!');
    }
  }
};
TExternalServiceListResp.prototype = {};
TExternalServiceListResp.prototype.read = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
    ...
    switch (fid) {
      ...
      case 2:
      if (ftype == Thrift.Type.LIST) {
        this.externalServiceInfos = [];
        var _rtmp395 = input.readListBegin();
        var _size94 = _rtmp395.size || 0;
        for (var _i96 = 0; _i96 < _size94; ++_i96) {
          var elem97 = null;
          elem97 = new ttypes.TExternalServiceEntry();
          elem97.read(input);
          this.externalServiceInfos.push(elem97);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TExternalServiceListResp.prototype.write = function(output) {
  output.writeStructBegin('TExternalServiceListResp');
  if (this.status !== null && this.status !== undefined) {
    output.writeFieldBegin('status', Thrift.Type.STRUCT, 1);
    this.status.write(output);
    output.writeFieldEnd();
  }
  if (this.externalServiceInfos !== null && this.externalServiceInfos !== undefined) {
    output.writeFieldBegin('externalServiceInfos', Thrift.Type.LIST, 2);
    output.writeListBegin(Thrift.Type.STRUCT, this.externalServiceInfos.length);
    for (var iter98 in this.externalServiceInfos) {
      if (this.externalServiceInfos.hasOwnProperty(iter98)) {
        iter98 = this.externalServiceInfos[iter98];
        iter98.write(output);
      }
    }
    output.writeListEnd();
...
var TExternalServiceEntry = module.exports.TExternalServiceEntry = function(args) {
  ...
  if (args) {
    ...
    if (args.className !== undefined && args.className !== null) {
      ...
      throw new Thrift.TProtocolException(Thrift.TProtocolExceptionType.UNKNOWN, 'Required field className is unset!');
    }
...
TExternalServiceEntry.prototype = {};
TExternalServiceEntry.prototype.read = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
    ...
    switch (fid) {
      ...
      case 5:
      if (ftype == Thrift.Type.BYTE) {
        this.serviceType = input.readByte();
      } else {
        input.skip(ftype);
      }
      break;
...
TExternalServiceEntry.prototype.write = function(output) {
  output.writeStructBegin('TExternalServiceEntry');
  ...
  if (this.state !== null && this.state !== undefined) {
    output.writeFieldBegin('state', Thrift.Type.BYTE, 3);
    output.writeByte(this.state);
    output.writeFieldEnd();
  }
  if (this.dataNodeId !== null && this.dataNodeId !== undefined) {
    output.writeFieldBegin('dataNodeId', Thrift.Type.I32, 4);
    output.writeI32(this.dataNodeId);
    output.writeFieldEnd();
  }
  if (this.serviceType !== null && this.serviceType !== undefined) {
    output.writeFieldBegin('serviceType', Thrift.Type.BYTE, 5);
    output.writeByte(this.serviceType);
    output.writeFieldEnd();
  }
  output.writeFieldStop();
  output.writeStructEnd();
...
var TShowAppliedConfigurationsResp = module.exports.TShowAppliedConfigurationsResp = function(args) {
  this.status = null;
  this.data = null;
  if (args) {
    if (args.status !== undefined && args.status !== null) {
...
TShowAppliedConfigurationsResp.prototype = {};
TShowAppliedConfigurationsResp.prototype.read = function(input) {
  input.readStructBegin();
  while (true) {
    var ret = input.readFieldBegin();
    var ftype = ret.ftype;
...
TShowAppliedConfigurationsResp.prototype.write = function(output) {
  output.writeStructBegin('TShowAppliedConfigurationsResp');
  if (this.status !== null && this.status !== undefined) {
    output.writeFieldBegin('status', Thrift.Type.STRUCT, 1);
    this.status.write(output);
    output.writeFieldEnd();
  ...
  if (this.data !== null && this.data !== undefined) {
    ...
    for (var kiter104 in this.data) {
      if (this.data.hasOwnProperty(kiter104)) {
        var viter105 = this.data[kiter104];
